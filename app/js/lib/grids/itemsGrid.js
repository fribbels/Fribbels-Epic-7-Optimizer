    ...
    initialize: async () => {
        ...
        const gridOptions = {
            ...
            columnDefs: [
                ...
                {headerName: i18next.t('Rank'), field: 'rank'},
                ...
                {headerName: i18next.t('Main'), field: 'main.type', filter: 'agTextColumnFilter', width: 100, cellRenderer: (params) => renderStat(params.value)},
                ...
                {headerName: i18next.t('Equipped'), field: 'equippedByName', width: 120},
                // {headerName: i18next.t('Mconf'), field: 'mconfidence', width: 50},
                // {headerName: i18next.t('Material'), field: 'material', width: 120},
                {headerName: i18next.t('Locked'), field: 'locked', cellRenderer: (params) => params.value == true ? 'yes' : 'no'},
