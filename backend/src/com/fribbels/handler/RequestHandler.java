...
public class RequestHandler {
    ...
    private static final Gson gson = new Gson();
//    private static final OptimizationRequestHandler optimizationRequestHandler = new OptimizationRequestHandler();
...
//            writeFile(response);
    ...
    private String handleSpecificRequest(final Request request, final String data) {
        ...
        if ("OptimizationRequest".equals(requestType)) {
//            return optimizationRequestHandler.handleRequest(data);
        }
